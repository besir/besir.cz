<?php //netteCache[01]001430a:2:{s:4:"time";s:21:"0.00140300 1373579579";s:9:"callbacks";a:8:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:67:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/config.neon";i:2;i:1372097464;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:70:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/factories.neon";i:2;i:1372097464;}i:2;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:71:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/components.neon";i:2;i:1372097464;}i:3;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:69:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/services.neon";i:2;i:1372097462;}i:4;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:66:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/forms.neon";i:2;i:1372097462;}i:5;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:70:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/model.dao.neon";i:2;i:1372097464;}i:6;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:74:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/model.service.neon";i:2;i:1372097462;}i:7;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:73:"/mnt/data/accounts/s/sirbesir/data/www/besir/app/config/config.local.neon";i:2;i:1372097464;}}}?><?php
// source: /mnt/data/accounts/s/sirbesir/data/www/besir/app/config/config.neon production
// source: /mnt/data/accounts/s/sirbesir/data/www/besir/app/config/config.local.neon 

/**
 * @property Security\AuthorizatorDao $AuthorizatorDao
 * @property Security\AuthorizatorService $AuthorizatorService
 * @property Nette\Application\Application $application
 * @property DatabaseAuthenticator $authenticator
 * @property Security\Authorizator $authorizator
...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.mailer, nette.database, AuthorizatorDao, AuthorizatorService, authorizator, authenticator, container,
		...
		'security\\authorizatordao' => 'AuthorizatorDao',
		'security\\authorizatorservice' => 'AuthorizatorService',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/mnt/data/accounts/s/sirbesir/data/www/besir/app',
			'wwwDir' => '/mnt/data/accounts/s/sirbesir/data/www/besir/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/mnt/data/accounts/s/sirbesir/data/www/besir/app/../temp',
			'database' => array(
	 ...
	 */
	protected function createService__AuthorizatorDao()
	{
		$service = new \Security\AuthorizatorDao($this->getService('nette.database.default'));
		if (!$service instanceof Security\AuthorizatorDao) {
			throw new Nette\UnexpectedValueException('Unable to create service \'AuthorizatorDao\', value returned by factory is not Security\\AuthorizatorDao type.');
		}
		return $service;
	}
	 ...
	 */
	protected function createService__AuthorizatorService()
	{
		$service = new \Security\AuthorizatorService($this->getService('AuthorizatorDao'));
		if (!$service instanceof Security\AuthorizatorService) {
			throw new Nette\UnexpectedValueException('Unable to create service \'AuthorizatorService\', value returned by factory is not Security\\AuthorizatorService type.');
		}
		return $service;
	}
	...
	{
		$service = new DatabaseAuthenticator($this->getService('nette.database.default'));
		return $service;
	}
	...
	{
		$service = new \Security\Authorizator($this->getService('AuthorizatorService'));
		if (!$service instanceof Security\Authorizator) {
			throw new Nette\UnexpectedValueException('Unable to create service \'authorizator\', value returned by factory is not Security\\Authorizator type.');
		}
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/mnt/data/accounts/s/sirbesir/data/www/besir/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/mnt/data/accounts/s/sirbesir/data/www/besir/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=ChangeMe', 'changeMe', 'changeMe', array(
			'' => TRUE,
		));
	...
	{
		$service = new Nette\Application\PresenterFactory('/mnt/data/accounts/s/sirbesir/data/www/besir/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/mnt/data/accounts/s/sirbesir/data/www/besir/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
